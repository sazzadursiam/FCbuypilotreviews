...
<footer id="footer" class="footer">
            ...
            <div class="row gy-4">
                <div class="col-lg-5 col-md-12 footer-info">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam laudantium unde facilis, aliquam
                        recusandae similique dolore aspernatur vel eveniet voluptatum cum tempore?</p>
                ...
                <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                    ...
                    <p>
                        ...
                        New York,<br>
                        United States <br><br>
                        <strong>Phone:</strong> +8 5555 66666 77<br>
                        <strong>Email:</strong> info@support.com<br>
                    </p>
    ...
    <div class="container">
        <div class="copyright">
            &copy; 2024 <strong><span>Buy Trustpilot Reviews</span></strong>. All Rights Reserved
        </div>
    </div>
</footer><!-- End Footer -->
